# -*- coding: utf-8 -*-
"""
Created on Fri Sep 13 15:54:32 2024
...
print("Số lượng người tham gia chơi bum chiến xùm: ", so_nguoi_choi)
ds_nguoi_choi = [f"Người chơi {i}" for i in range(1,so_nguoi_choi +1)]
so_hiep = int(input("nhập vào số lần hiệp bum chiến xùm với máy: "))
hoa = 0
